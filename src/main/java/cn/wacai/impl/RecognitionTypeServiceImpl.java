...
public class RecognitionTypeServiceImpl implements RecognitionTypeService {
    ...
    private void initTradingPartyMap() {
        ...
        tradingPartyMap.put("乐成香黄焖鸡米饭", wacaiAccountVoType2);
        tradingPartyMap.put("赵四宏", wacaiAccountVoType2);
        tradingPartyMap.put("*守伟", wacaiAccountVoType2);
        tradingPartyMap.put("南城香2", wacaiAccountVoType2);
        tradingPartyMap.put("天津市河西区崃山小吃店", wacaiAccountVoType2);
        tradingPartyMap.put("呷哺呷哺（北京）", wacaiAccountVoType2);
        tradingPartyMap.put("晓蕊家凉皮酱货凉拌菜", wacaiAccountVoType2);
        tradingPartyMap.put("美团点评平台商户", wacaiAccountVoType2);
        tradingPartyMap.put("*军", wacaiAccountVoType2);
        tradingPartyMap.put("天津家宴妈妈菜胜利路店", wacaiAccountVoType2);
        tradingPartyMap.put("新煮意（远洋店）", wacaiAccountVoType2);
        tradingPartyMap.put("*胡 立才", wacaiAccountVoType2);
        tradingPartyMap.put("柒一拾壹（北京）有限公司", wacaiAccountVoType2);
        tradingPartyMap.put("麦多馅饼", wacaiAccountVoType2);
        tradingPartyMap.put("董记煎饼", wacaiAccountVoType2);
        tradingPartyMap.put("崔永霞", wacaiAccountVoType2);
        tradingPartyMap.put("肯德基", wacaiAccountVoType2);
        tradingPartyMap.put("福众源", wacaiAccountVoType2);
        tradingPartyMap.put("天津金拱门食品有限公司", wacaiAccountVoType2);
        tradingPartyMap.put("煎饼果子大饼鸡蛋鸡柳", wacaiAccountVoType2);
        tradingPartyMap.put("厚先生土豆粉屿东城店", wacaiAccountVoType2);
        tradingPartyMap.put("早点", wacaiAccountVoType2);
        tradingPartyMap.put("小吊梨汤", wacaiAccountVoType2);
        tradingPartyMap.put("卫金水", wacaiAccountVoType2);
        tradingPartyMap.put("*代勇", wacaiAccountVoType2);
        tradingPartyMap.put("吕贺美", wacaiAccountVoType2);
        tradingPartyMap.put("王凯风", wacaiAccountVoType2);
        tradingPartyMap.put("有??人", wacaiAccountVoType2);
        tradingPartyMap.put("天津市德顺利餐饮服务有限公司", wacaiAccountVoType2);
        tradingPartyMap.put("涂涂画画", wacaiAccountVoType2);
        tradingPartyMap.put("百姓家(亦庄店)", wacaiAccountVoType2);
        ...
        tradingPartyMap.put("河间正宗驴肉火烧", wacaiAccountVoType2);
        tradingPartyMap.put("晋老西面馆", wacaiAccountVoType2);
        tradingPartyMap.put("郭氏清味斋", wacaiAccountVoType2);
        tradingPartyMap.put("和平鸽味口全饺子馆", wacaiAccountVoType2);
        tradingPartyMap.put("煎饼果子", wacaiAccountVoType2);
        tradingPartyMap.put("北京麦当劳食品有限公司", wacaiAccountVoType2);
        tradingPartyMap.put("*秀萍", wacaiAccountVoType2);
        tradingPartyMap.put("王朋", wacaiAccountVoType2);
        ...
        tradingPartyMap.put("西安老豆腐", wacaiAccountVoType2);
        tradingPartyMap.put("蜀留香火锅", wacaiAccountVoType2);
        ...
        tradingPartyMap.put("*千一", wacaiAccountVoType3);
        ...
        tradingPartyMap.put("天津市河东区天天友联超市", wacaiAccountVoType3);
        tradingPartyMap.put("友联超市", wacaiAccountVoType3);
        ...
        tradingPartyMap.put("去哪儿网", wacaiAccountVoType5);
        tradingPartyMap.put("携程Tripcom", wacaiAccountVoType5);

        WacaiAccountVo wacaiAccountVoType6= new WacaiAccountVo();
        wacaiAccountVoType6.setExpenditureCategories("餐饮");
        wacaiAccountVoType6.setExpenditureCategory("买菜原料");
        tradingPartyMap.put("川牧牛羊肉批发零售", wacaiAccountVoType6);
        tradingPartyMap.put("瑞祥油酥大饼", wacaiAccountVoType6);
        tradingPartyMap.put("蔬菜店", wacaiAccountVoType6);
        tradingPartyMap.put("*海霞", wacaiAccountVoType6);
        tradingPartyMap.put("雨润冷鲜肉", wacaiAccountVoType6);
        tradingPartyMap.put("老左精品菜摊", wacaiAccountVoType6);
        tradingPartyMap.put("顺鑫水产", wacaiAccountVoType6);
        tradingPartyMap.put("鲜惠生鲜超市", wacaiAccountVoType6);
        tradingPartyMap.put("孙金军", wacaiAccountVoType6);
        tradingPartyMap.put("二厂酱货", wacaiAccountVoType6);
        tradingPartyMap.put("姚宝环", wacaiAccountVoType6);
        tradingPartyMap.put("川牧牛羊肉", wacaiAccountVoType6);
        tradingPartyMap.put("陈伟", wacaiAccountVoType6);
        tradingPartyMap.put("粮油店", wacaiAccountVoType6);
        tradingPartyMap.put("雷雪", wacaiAccountVoType6);
        tradingPartyMap.put("*来妮", wacaiAccountVoType6);
        tradingPartyMap.put("李记副食调料", wacaiAccountVoType6);
        tradingPartyMap.put("老左精品菜摊。", wacaiAccountVoType6);
        tradingPartyMap.put("鲁春芝", wacaiAccountVoType6);
        tradingPartyMap.put("*强", wacaiAccountVoType6);
        tradingPartyMap.put("老左莱摊", wacaiAccountVoType6);
        tradingPartyMap.put("共同发财", wacaiAccountVoType6);
        tradingPartyMap.put("玉芹", wacaiAccountVoType6);
        tradingPartyMap.put("李秀芳", wacaiAccountVoType6);
        tradingPartyMap.put("刘进", wacaiAccountVoType6);
        tradingPartyMap.put("孟哲", wacaiAccountVoType6);
        ...
        tradingPartyMap.put("许化中", wacaiAccountVoType6);
        tradingPartyMap.put("*华", wacaiAccountVoType6);
        tradingPartyMap.put("王宝华", wacaiAccountVoType6);
        tradingPartyMap.put("大刀凉皮", wacaiAccountVoType6);
        tradingPartyMap.put("瑞祥大饼", wacaiAccountVoType6);
        tradingPartyMap.put("重庆放心切面店", wacaiAccountVoType6);
        tradingPartyMap.put("老左莱摊", wacaiAccountVoType6);
        tradingPartyMap.put("程海香", wacaiAccountVoType6);
        tradingPartyMap.put("任卫杰", wacaiAccountVoType6);
        tradingPartyMap.put("房艳", wacaiAccountVoType6);
        tradingPartyMap.put("牛羊肉", wacaiAccountVoType6);
        tradingPartyMap.put("娟娟", wacaiAccountVoType6);
        ...
        tradingPartyMap.put("A董明峰13821950376", wacaiAccountVoType6);
        tradingPartyMap.put("王凯风", wacaiAccountVoType6);
        tradingPartyMap.put("西安老豆腐", wacaiAccountVoType6);
        tradingPartyMap.put("吕贺美", wacaiAccountVoType6);


        WacaiAccountVo wacaiAccountVoType7= new WacaiAccountVo();
        wacaiAccountVoType7.setExpenditureCategories("餐饮");
        wacaiAccountVoType7.setExpenditureCategory("饮料水果");
        tradingPartyMap.put("俺家水果放心吃", wacaiAccountVoType7);
        tradingPartyMap.put("鲜惠生鲜超市", wacaiAccountVoType7);
        tradingPartyMap.put("好人，彩丽园店", wacaiAccountVoType7);
        tradingPartyMap.put("果生鲜", wacaiAccountVoType7);
        tradingPartyMap.put("蜡笔小新", wacaiAccountVoType7);
        tradingPartyMap.put("意中人", wacaiAccountVoType7);
        tradingPartyMap.put("马振超", wacaiAccountVoType7);
        ...
        tradingPartyMap.put("星巴克(北京电子城国电总部店)", wacaiAccountVoType7);
        tradingPartyMap.put("轩蕊烟酒", wacaiAccountVoType7);
        tradingPartyMap.put("鲜丰水果(天津北斗花园店)", wacaiAccountVoType7);
        tradingPartyMap.put("张珊", wacaiAccountVoType7);

        tradingPartyMap.put("娟娟水果店", wacaiAccountVoType7);
        tradingPartyMap.put("王宝华", wacaiAccountVoType7);

        WacaiAccountVo wacaiAccountVoType8= new WacaiAccountVo();
        wacaiAccountVoType8.setExpenditureCategories("餐饮");
        wacaiAccountVoType8.setExpenditureCategory("零食");
        tradingPartyMap.put("孙付灵", wacaiAccountVoType8);
        tradingPartyMap.put("第戎蛋糕", wacaiAccountVoType8);
        tradingPartyMap.put("胖子干货", wacaiAccountVoType8);
        ...
        tradingPartyMap.put("五福心语太阳城店", wacaiAccountVoType8);
        ...
        tradingPartyMap.put("小宝栗子利民道店", wacaiAccountVoType8);
        tradingPartyMap.put("老味果仁(西楼后街店)", wacaiAccountVoType8);

        tradingPartyMap.put("胖子精品干货", wacaiAccountVoType8);
        ...
        tradingPartyMap.put("okumura旗舰店", wacaiAccountVoType13);
        ...
        tradingPartyMap.put("天津市第一中心医院", wacaiAccountVoType14);
        tradingPartyMap.put("天津河西荣皖中医医院", wacaiAccountVoType14);
        tradingPartyMap.put("深圳市海王星辰医药有限公司", wacaiAccountVoType14);
        ...
        tradingPartyMap.put("黑狗科技", wacaiAccountVoType16);
        ...
        tradingPartyMap.put("中国平安财产保险股份有限公司", wacaiAccountVoType17);
        ...
        tradingPartyMap.put("tb098868850", wacaiAccountVoType18);
        tradingPartyMap.put("色块数码配件专营店", wacaiAccountVoType18);
        tradingPartyMap.put("华为终端有限公司", wacaiAccountVoType18);
        tradingPartyMap.put("铁三角官方旗舰店", wacaiAccountVoType18);
        ...
        tradingPartyMap.put("艾欧史密斯(中国)热水器有限公司", wacaiAccountVoType20);
        tradingPartyMap.put("燃气万新站新)", wacaiAccountVoType20);
        ...
        tradingPartyMap.put("猫森林旗舰店", wacaiAccountVoType21);
        tradingPartyMap.put("光合宠物医院", wacaiAccountVoType21);
        tradingPartyMap.put("益启玩家居专营店", wacaiAccountVoType21);
        ...
        tradingPartyMap.put("北京摩拜科技有限公司", wacaiAccountVoType25);
        ...
        WacaiAccountVo wacaiAccountVoType30= new WacaiAccountVo();
        wacaiAccountVoType30.setExpenditureCategories("购物");
        wacaiAccountVoType30.setExpenditureCategory("服饰鞋帽");
        tradingPartyMap.put("恒源祥旗舰店", wacaiAccountVoType30);

        WacaiAccountVo wacaiAccountVoType31= new WacaiAccountVo();
        wacaiAccountVoType31.setExpenditureCategories("居家");
        wacaiAccountVoType31.setExpenditureCategory("物业");
        tradingPartyMap.put("中铁二院物业", wacaiAccountVoType31);
        tradingPartyMap.put("彩丽园水站", wacaiAccountVoType31);

        WacaiAccountVo wacaiAccountVoType32= new WacaiAccountVo();
        wacaiAccountVoType32.setExpenditureCategories("餐饮");
        wacaiAccountVoType32.setExpenditureCategory("油盐酱醋");
        tradingPartyMap.put("飞象企服", wacaiAccountVoType32);
